...
for($x=0;$x<7;$x++){ //Output data in each row
    if(($row = $result->fetch_assoc())!=NULL){ 
        ...
        $level=$row["priorityLVL"];
        
        if($level=='h'){ //red if high priority
            echo "<td class=\" table-danger text-center\" rowspan=\"1\"><div class=\"row-fluid lecture\" style=\"width: 99%; height: 100%; padding:4px;\">";
            echo "<span class=\"title\">" . $row["taskTitle"] . "</span>";
        }else if($level=='m'){ //blue if medium priority
        ...
        }else if($level=='l'){ //yellow if low priority 
            echo "<td class=\" table-warning text-center\" rowspan=\"1\"><div class=\"row-fluid lecture\" style=\"width: 99%; height: 100%; padding:4px;\">";
            echo "<span class=\"title\">" . $row["taskTitle"] . "</span>";// <span class=\"lecturer\"><a>" . $row["priorityLVL"] . "</a></span></div></td>";  
        }
